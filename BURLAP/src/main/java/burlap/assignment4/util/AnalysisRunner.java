...
public class AnalysisRunner {
	...
	public static void simpleValueFunctionVis(ValueFunction valueFunction, Policy p, 
	...
	public void runQLearning(BasicGridWorld gen, Domain domain,
			...
			SimulatedEnvironment env, double epsilon, double lr, boolean showPolicyMap) {
		System.out.println("//Q Learning Analysis//");
		System.out.println(String.format("Epsilon= %f; Learning Rate=%f", epsilon, lr));
